...
<html lang="en">
<head>
   <title>SPARK BANK - Network</title>
   <meta charset="utf-8">
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/1.jpg" alt="Easy Transfer" width="1100" height="500">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Spark Bank</h1>
      <p1> Spark Bank is a part of The Spark foundation Network. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, Spark Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. This Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that Spark Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>SEEMA MT</b> </br>Intern @, The Spark Foundation Network</p>
      </footer>
